  ...
  return (
    <div className="mx-6 space-y-5">
      ...
      <section>
        ...
        <p>
          By inviting this bot and/or use the commands of the bot, you agree that you have read and understand the Terms of Service and Privacy Policy of the bot. 
          <br /> You also agree that you will use this bot in a manner that is in compliance with the Discord <a href="https://discord.com/terms" className="text-blue-800">Terms of Service</a> and <a href="https://discord.com/guidelines" className="text-blue-800">Community Guidelines</a>.
      ...
      <section>
        ...
        <br />
        <p>
          PoroScout will never share your any personal identifying information publicly without your concent unless required by law.
      ...
      <section>
        ...
        <p>
          ...
          Any direct connection to Discord and/or it's trademark 
          is purely coincidental. 
          We do not claim to have any copyright
          ownership of Discord and/or it's assets.
        </p>
      </section>
